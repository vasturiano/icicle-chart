...
| <b>tooltipContent</b>([<i>string</i> or <i>fn</i>]) | Getter/setter for a node object tooltip content accessor. Use this to specify extra content in each of the segment's tooltips in addition to the node's full hierarchical name that's included by default. | |
